...
The default install boots gt-bot Telegram bridge + Mayor + Dolt with local voice transcription baked in (the ~75MB ggml model lazy-downloads on the first voice DM and is cached on a persisted volume). One overlay is available:
